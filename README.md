...
pnpm test                    # 216 TypeScript unit tests plus 106 Foundry tests
```
...
- **Code quality.** 106 Foundry plus 216 TypeScript tests in CI on every push, arithmetic mirrors
...
216 unit tests including the red-team suite. Next:
