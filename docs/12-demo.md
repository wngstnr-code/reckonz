...
**Layar.** Scroll ke `HowItWorks`. Empat kartu, masing-masing dengan gambarnya, namanya, dan satu
baris. Frame-nya membuka lewat clip-path waktu barisnya tiba dan namanya bergulir ke tempatnya.
Diamkan sampai baris kedua selesai mendarat, lalu naik ke top bar dan klik masuk ke app. **Jangan
cut ke `/assets`. Klik tombolnya dan biarkan halamannya termuat.**

Dua belas detik lagi, bukan delapan. Frame-nya sudah berisi sejak 2026-08-20, jadi menahannya
sekarang memberi penonton sesuatu untuk dilihat, bukan menyuruhnya menunggu gambar yang tidak
akan datang. Itu alasan angkanya pernah turun dan alasan angkanya naik lagi.
...
> Those are the four, so let us go and open the real ones.
...
| 3 | landing, `HowItWorks` | Tahan sampai baris kedua selesai mendarat, supaya keempat gambarnya sempat terbaca. Akhiri dengan klik masuk ke app |
